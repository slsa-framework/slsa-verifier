...
func Test_VerifyProvenance(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			path:         "./testdata/v0.0.2/dsse-not-slsa.intoto.jsonl",
			artifactHash: "0ae7e4fa71686538440012ee36a2634dbaa19df2dd16a466f52411fb348bbc4e",
			expected:     ErrorInvalidDssePayload,
		},
		{
			name:         "invalid dsse: nil subject",
			path:         "./testdata/v0.0.2/dsse-no-subject.intoto.jsonl",
			artifactHash: "0ae7e4fa71686538440012ee36a2634dbaa19df2dd16a466f52411fb348bbc4e",
			expected:     ErrorInvalidDssePayload,
		},
		{
			name:         "invalid dsse: no sha256 subject digest",
			path:         "./testdata/v0.0.2/dsse-no-subject-hash.intoto.jsonl",
			artifactHash: "0ae7e4fa71686538440012ee36a2634dbaa19df2dd16a466f52411fb348bbc4e",
			expected:     ErrorInvalidDssePayload,
		},
		{
			name:         "mismatched artifact hash with env",
			path:         "./testdata/v0.0.2/dsse-valid.intoto.jsonl",
...
func Test_VerifyBranch(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name:   "ref main",
			path:   "./testdata/v0.0.2/dsse-main-ref.intoto.jsonl",
			branch: "main",
		},
		{
			name:   "ref branch3",
			path:   "./testdata/v0.0.2/dsse-branch3-ref.intoto.jsonl",
			branch: "branch3",
		},
		{
			name:     "invalid ref type",
			path:     "./testdata/v0.0.2/dsse-invalid-ref-type.intoto.jsonl",
			expected: ErrorInvalidDssePayload,
		},
		{
			name:   "tag branch2",
			path:   "./testdata/v0.0.2/dsse-branch2-tag.intoto.jsonl",
			branch: "branch2",
		},
	}
	for _, tt := range tests {
...
func Test_VerifyTag(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name: "tag vslsa1",
			path: "./testdata/v0.0.2/dsse-vslsa1-tag.intoto.jsonl",
			tag:  "vslsa1",
		},
	}
	for _, tt := range tests {
...
func Test_VerifyVersionedTag(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			path:     "./testdata/v0.0.2/dsse-v1.2-tag.intoto.jsonl",
			tag:      "1.2",
			expected: ErrorInvalidSemver,
		},
		{
		...
		},
		{
			...
			path: "./testdata/v0.0.2/dsse-v1.2.3-tag.intoto.jsonl",
			tag:  "v1.2.3",
		},
		{
		...
		},
		{
			...
			path: "./testdata/v0.0.2/dsse-v1.2.3-alpha-tag.intoto.jsonl",
			tag:  "v1.2.3-alpha",
		},
		{
		...
		},
		{
			...
			path: "./testdata/v0.0.2/dsse-v1.2.3-alpha+123-tag.intoto.jsonl",
			tag:  "v1.2.3-alpha",
		},
		{
		...
		},
		{
			...
			path:     "./testdata/v0.0.2/dsse-v1.2.3+123-tag.intoto.jsonl",
			tag:      "v1.2.3-alpha+123",
			expected: ErrorMismatchVersionedTag,
		},
		{
		...
		},
		{
			...
			path: "./testdata/v0.0.2/dsse-v1-tag.intoto.jsonl",
			tag:  "v1",
		},
		{
