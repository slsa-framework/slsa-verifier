...
var (
	...
	// NpmCLIBuildTypeV1 is the buildType for provenance generated by the npm cli for v0.2 provenance before GA.
	NpmCLIBuildTypeV02_1 = "https://github.com/npm/cli/gha@v1"

	// NpmCLIBuildTypeV2 is the buildType for provenance generated by the npm cli for v0.2 provenance after GA.
	NpmCLIBuildTypeV02_2 = "https://github.com/npm/cli/gha/v2"

	// NpmCLIBuildTypeV1_1 is the buildType for provenance generated by the npm cli for v1.0.
	NpmCLIBuildTypeV1_1 = "https://slsa-framework.github.io/github-actions-buildtypes/workflow/v1"
)
